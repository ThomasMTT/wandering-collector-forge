...
public class ItemFilterUtil {
    ...
    /**
     * Checks if the given ItemStack is excluded from trading.
     *
     ...
     *
     * @param stack The ItemStack to check.
     * @return True if the item is an enchanted book, false otherwise.
     */
    ...
    /**
     * Checks if the given ItemStack is a valuable block.
     *
     * @param stack The ItemStack to check.
     * @return True if the item is a valuable block, false otherwise.
     */
    ...
    /**
     * Checks if the given ItemStack is a valuable ingot.
     *
     * @param stack The ItemStack to check.
     * @return True if the item is a valuable ingot, false otherwise.
     */
    ...
    /**
     * Checks if the given ItemStack is a potion that provides effects.
     *
     * @param stack The ItemStack to check.
     * @return True if the item is an effect potion, false otherwise.
     */
    ...
    /**
     * Retrieves the configured price for a given ItemStack.
     *
     * @param stack The ItemStack to check.
     * @return The configured price if found, or -1 if not.
     */
