...
/**
 * A class that holds constant values used throughout the Wandering Collector mod.
 * This includes mod identifiers, loot storage, and key strings for item management.
 */
