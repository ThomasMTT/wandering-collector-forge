...
/**
 * Helper class for managing player loot data, including adding and handling stackable items.
 */
public class PlayerLootDataHelper {
     ...
     * @param eventStack       The stack being handled.
     * @param player           The player whose loot is being managed.
     */
    ...
    /**
     * Adds a new item to the player's loot list.
     *
     * @param player The player to add loot for.
