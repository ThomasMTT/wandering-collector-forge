...
/**
 * A calculator class for determining the price of item stacks.
 */
public class StackPriceCalculator {
    ...
    /**
     * Calculates the price of a given ItemStack based on its type, enchantments, and other factors.
     *
     * @param stack The ItemStack whose price is to be calculated.
     * @return The calculated price of the stack.
     */
    public static int getStackPrice(ItemStack stack) {
        ...
        if (isWeapon(stack)) {
            ...
            if (item instanceof BowItem || item instanceof CrossbowItem || item instanceof TridentItem) {
                ...
                if (sword.getTier().equals(ItemTier.NETHERITE)) {
                    price *= 2;
                }
            }
            ...
            if (stack.getItem() instanceof ElytraItem) {
                ...
                if (armor.getMaterial().equals(ArmorMaterial.NETHERITE)) {
                    price *= 2;
                }
            }
