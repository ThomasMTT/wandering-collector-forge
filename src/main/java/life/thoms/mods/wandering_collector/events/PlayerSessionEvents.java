 ...
 * managing the persistence of player loot.
 */
@Mod.EventBusSubscriber(modid = ModConstants.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE)
public class PlayerSessionEvents {

    /**
     * Called when a player logs in. It removes any existing loot for the player
     * from the server and loads their loot data.
     *
    ...
    /**
     * Called when a player logs out. It saves the player's loot data
     * and removes it from the server.
     *
