...
/**
 * Handles events related to interacting with and trading with the Wandering Trader.
 */
@Mod.EventBusSubscriber(modid = ModConstants.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE)
public class WanderingTraderEvents {

    /**
     * Handles interactions with the Wandering Trader.
     *
    ...
    /**
     * Handles trading events with the Wandering Trader.
     *
