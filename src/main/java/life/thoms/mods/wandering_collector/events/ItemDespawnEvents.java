...
/**
 * Handles events related to item entities leaving the game level.
 * Specifically, it manages the logic for when items despawn, saving
 * their state and associating them with players.
 */
...
public class ItemDespawnEvents {
     ...
     * If the entity is an item entity that has despawned, it saves the
     * item's state to the associated player's loot.
     *
     * @param event The event containing information about the entity leaving the level.
     */
    @SubscribeEvent
