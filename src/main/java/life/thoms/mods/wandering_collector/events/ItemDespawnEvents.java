...
/**
 * Handles events related to item despawning in the game.
 *
 * This class listens for item entity leave level events and manages
 * the loot persistence for items that are about to despawn.
 */
...
public class ItemDespawnEvents {
     ...
     *
     * @param event the event containing information about the entity leaving
     */
    @SubscribeEvent
