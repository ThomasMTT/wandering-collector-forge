...
/**
 * Handles player-related events, such as death and block interactions.
 * <p>
 * This class listens for player death events and interactions with blocks,
 * specifically to manage inventory ownership and summon traders.
 */
...
public class PlayerEvents {
     ...
     *
     * @param playerDeathEvent the event containing information about the player's death
     */
    @SubscribeEvent
