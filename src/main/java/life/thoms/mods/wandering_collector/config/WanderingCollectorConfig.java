 ...
 * This class holds the configuration options and their default values.
 */
public class WanderingCollectorConfig {
    ...
    static {
        ...
        VALUABLE_ITEM_IDS = builder
                ...
                .defineList("VALUABLE_ITEM_IDS", Arrays.asList(
                ...
                ), value -> value instanceof String); // Ensure all entries are strings
        ...
        VALUABLE_TAG_IDS = builder
                ...
                .defineList("VALUABLE_TAG_IDS", Collections.emptyList(), value -> value instanceof String); // Initialize as an empty list
