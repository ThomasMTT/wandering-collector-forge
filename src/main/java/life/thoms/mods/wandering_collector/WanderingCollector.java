 ...
 * Registers configuration and event handlers during mod initialization.
 */
@Mod(ModConstants.MOD_ID)
public class WanderingCollector {

    /**
     * Constructor for the WanderingCollector mod.
     * Registers the mod's event bus and configuration settings.
     */
    ...
    /**
     * Registers event handlers with the specified event bus.
     *
     * @param modEventBus The event bus to register the events with.
     */
